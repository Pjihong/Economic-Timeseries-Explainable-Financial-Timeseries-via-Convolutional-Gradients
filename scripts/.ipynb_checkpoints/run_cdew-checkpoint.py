...
from run_metrics import find_bundle, load_model_bundle_compat, run_metrics_over_time_compat
...
def main():
    ...
    met = run_metrics_over_time_compat(
        model=model,
        meta=meta,
        cfg=cfg,
        df_raw=df_raw,
    ...
    run_cdew_analysis(
        ...
        Ea_all=met["Ea_all"],
        cam_all=met["cam_all"],
        raw_windows=met["raw_windows"],
        is_event=met["is_event"],
        label_dates=met["label_dates"],
        N=met["N"],
        refs=met["refs"],
