...
![AUC by metric](output/metrics/metric_auc_bar.png)
...
![DTW metrics over time](output/metrics/metric_over_time.png)
...
![Metric distributions](output/metrics/metric_boxplots.png)
...
![Mean CAM abs](posthoc/mean_cam_abs.png)
...
![Mean CAM signed](posthoc/mean_cam_signed.png)
...
![COM distribution](posthoc/com_distribution.png)
...
![FOC distribution](posthoc/foc_distribution.png)
...
![Deletion: Important vs Random](posthoc/deletion_vs_random.png)
...
![Matching balance](posthoc/matching_balance_plot.png)
