...
![AUC by metric](./metric_auc_bar.png)
...
![DTW metrics over time](./metric_over_time.png)
...
![Metric distributions](./metric_boxplots.png)
...
![Mean CAM signed](./mean_cam_signed.png)
...
![COM distribution](./com_distribution.png)
...
![FOC distribution](./foc_distribution.png)
...
![Deletion: Important vs Random](./deletion_vs_random.png)
...
![Matching balance](./matching_balance_plot.png)
